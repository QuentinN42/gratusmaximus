...
def query(txt: str, variable: dict[str, typing.Any] | None = None) -> dict[str, typing.Any]:
    res = httpx.post('https://www.meetup.com/gql2', json={'query': txt, 'variables': variable})
